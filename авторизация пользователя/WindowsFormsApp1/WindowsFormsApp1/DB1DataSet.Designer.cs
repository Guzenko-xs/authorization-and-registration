...
namespace WindowsFormsApp1 {
    ...
    public partial class DB1DataSet : global::System.Data.DataSet {
        ...
        public partial class Таблица1DataTable : global::System.Data.TypedTableBase<Таблица1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public Таблица1Row FindBylogin(string login) {
...
namespace WindowsFormsApp1.DB1DataSetTableAdapters {
    ...
    public partial class Таблица1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Таблица1` WHERE ((`login` = ?) AND ((? = 1 AND `password` IS NULL) O" +
                "R (`password` = ?)))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Таблица1` SET `login` = ?, `password` = ? WHERE ((`login` = ?) AND ((? = " +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT login, [password] FROM Таблица1";
